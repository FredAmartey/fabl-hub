...
export default function VideoPage({ params }: VideoPageProps) {
  ...
  useEffect(() => {
    // Optimized video data lookup - use Map for O(1) access
    const videoMap = new Map([
      [
        1,
        {
          ...
          trending: true,
          description:
            "Journey through ancient civilizations reimagined by our neural network. This AI-generated video explores what ancient Rome, Egypt, and Mesopotamia might have looked like, blending historical accuracy with artistic interpretation.",
          subscribers: "1.8M",
        },
      ],
      [
        2,
        {
          ...
          duration: "15:42",
          description:
            "The Last Cosmic Voyager is a fully AI-generated narrative about the final human expedition to the edge of the known universe. Our neural storytelling engine crafted this tale based on thousands of science fiction novels and scientific papers.",
        },
      ],
      [
        3,
        {
          ...
          trending: true,
          description:
            "Experience the world's first fully AI-composed symphony. Our music generation system analyzed thousands of classical compositions to create this unique piece that captures the essence of human emotion through digital means.",
        },
      ],
    ]);

    const foundVideo = videoMap.get(parseInt(videoId)) || null;
    setVideo(foundVideo);
    ...
    // Non-blocking scroll to top - use requestAnimationFrame
    ...
    <div className="px-6 pt-6 pb-12">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          ...
          {/* Video Info */}
          <h1 className="text-2xl font-bold font-afacad mb-2">{video.title}</h1>
          <div className="flex flex-wrap items-center justify-between mb-4">
            ...
            <div className="flex items-center space-x-2 mt-2 sm:mt-0">
              <Button
                ...
                className={isLiked ? "from-purple-600 to-blue-500" : ""}
              >
          ...
          <div className="flex items-start justify-between p-4 bg-[#1a1230] rounded-xl mb-6">
            <div className="flex items-start">
              <Link href={`/channel/${video.channelId}`} className="mr-3 flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-sm text-gray-300 mt-3">{video.description}</p>
              </div>
            </div>
          ...
          <div className="bg-[#1a1230] rounded-xl p-4">
            ...
            <div className="flex mb-4">
              <div className="w-8 h-8 rounded-full overflow-hidden mr-3 flex-shrink-0">
                <img
                  src="https://images.unsplash.com/photo-1599566150163-29194dcaad36?w=100&h=100&auto=format&fit=crop&crop=faces"
                  alt="Your avatar"
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="flex-1">
                <input
                  ...
                  className="w-full bg-[#241a38] border border-purple-500/30 rounded-lg py-2 px-3 focus:outline-none focus:border-purple-500 transition-colors"
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex">
                <div className="w-8 h-8 rounded-full overflow-hidden mr-3 flex-shrink-0">
                  <img
                    src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=100&h=100&auto=format&fit=crop&crop=faces"
                ...
                <div>
                  ...
                  <p className="text-sm mt-1">
                    This is absolutely mind-blowing! The AI has captured the essence of these
                    ancient civilizations in a way I&apos;ve never seen before.
                  </p>
                  <div className="flex items-center mt-2 text-xs text-gray-400">
                    ...
                    <button className="ml-3 hover:text-white transition-colors">Reply</button>
                  </div>
                </div>
              </div>
              <div className="flex">
                <div className="w-8 h-8 rounded-full overflow-hidden mr-3 flex-shrink-0">
                  <img
                    src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&auto=format&fit=crop&crop=faces"
                    alt="Commenter avatar"
                    className="w-full h-full object-cover"
                  />
                </div>
                <div>
                  ...
                  <p className="text-sm mt-1">
                    The detail in this is incredible. I&apos;m an archaeologist and I&apos;m
                    impressed by how the AI has interpreted historical data while still keeping
                    artistic freedom.
                  </p>
                  <div className="flex items-center mt-2 text-xs text-gray-400">
                    <button className="flex items-center hover:text-white transition-colors">
          ...
          <div className="space-y-4">
            {relatedVideos.map((video) => (
              <div key={video.id} className="flex">
                <Link
                  href={`/video/${video.id}`}
                  className="w-40 h-24 rounded-lg overflow-hidden flex-shrink-0 mr-2"
                >
                ...
                <div className="flex-1">
                  <Link
                    href={`/video/${video.id}`}
                    className="font-medium text-sm hover:text-purple-400 transition-colors line-clamp-2"
                  >
                    {video.title}
                  </Link>
                  <Link
                    href={`/channel/${video.channel.toLowerCase().replace(/\s/g, "")}`}
                    className="text-xs text-gray-400 hover:text-purple-400 transition-colors block mt-1"
                  >
                    {video.channel}
                  </Link>
